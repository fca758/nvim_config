...
vim.keymap.set({"n","v","o"},"h","<nop>",{noremap=true,silent=true})
vim.keymap.set({"n","v","o"},"j","<nop>",{noremap=true,silent=true})
vim.keymap.set({"n","v","o"},"k","<nop>",{noremap=true,silent=true})
vim.keymap.set({"n","v","o"},"l","<nop>",{noremap=true,silent=true})
...
vim.keymap.set({"n","v","o"},"ñ","l",{noremap=true,silent=true})
